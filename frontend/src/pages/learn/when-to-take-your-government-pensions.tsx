...
const WhenToTakeYourGovernmentPensions: FC = () => {
  const { t } = useTranslation('learn/when-to-take-your-government-pensions')
  return (
    <Layout>
      ...
      <p>
        <Trans
          ns="learn/when-to-take-your-government-pensions"
...
export const getServerSideProps: GetServerSideProps = async ({ locale }) => ({
  props: {
    ...(await serverSideTranslations(locale ?? 'default', [
      'common',
      'learn/when-to-take-your-government-pensions',
    ])),
  },
})
